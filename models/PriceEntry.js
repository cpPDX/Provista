...
const priceEntrySchema = new mongoose.Schema({
  ...
  source: { type: String, enum: ['manual', 'csv', 'shopping-trip'], default: 'manual' },
  shoppingTripId: { type: mongoose.Schema.Types.ObjectId, ref: 'ShoppingTrip', default: null },
...
priceEntrySchema.index({ householdId: 1, shoppingTripId: 1 });
